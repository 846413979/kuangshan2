 ...
 * Bootstrap 分页驱动
 */
class CustomBootstrap extends Paginator
{
    ...
    protected function getPreviousButton(string $text = "&laquo;"): string
    {
        ...
        if ($this->currentPage() <= 1) {
            return '<div class="pre pre1">
                                                                                    <div class="font">
                                                                                        <i class="iconfont"></i><span
                                                                                            class="i_pre">'.$text.'</span>
                                                                                    </div>
                                                                                </div>';
        }
...
//        return $this->getPageLinkWrapper($url, $text);
    ...
    {
        if (!$this->hasMore) {
            return '<div class="next next1">
                                                                                    <div class="font">
                                                                                        <i class="iconfont"></i><span
                                                                                            class="i_next">'.$text.'</span>
                                                                                    </div>
                                                                                </div>';
        }
    ...
    {
        return '<div class="pageNum active">' . $text . '</div>';
    }
    ...
    {
        return '<div class="pageNum">' . $text . '</div>';
    }
