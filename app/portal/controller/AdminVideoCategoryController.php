...
class AdminVideoCategoryController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        if (empty($keyword)) {
            $categoryTree = $portalCategoryModel->adminCategoryTableTree(5);
    ...
    public function add()
    {
        ...
        $portalCategoryModel = new PortalCategoryModel();
        $categoriesTree      = $portalCategoryModel->adminCategoryTree(5, $parentId);
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            ...
            $categoriesTree = $portalCategoryModel->adminCategoryTree(5, $category['parent_id'], $id);
...
tpl;
        ...
        $categoryTree = $portalCategoryModel->adminCategoryTableTree(5,$selectedIds, $tpl);
