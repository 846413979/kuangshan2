...
class AdminFileCategoryController extends AdminBaseController
{
    /**
     * 文章分类列表
     * @adminMenu(
    ...
    public function add()
    {
        ...
        $portalCategoryModel = new PortalCategoryModel();
        $categoriesTree      = $portalCategoryModel->adminCategoryTree(6, $parentId);
    ...
    public function addPost()
    {
        ...
        $this->success('添加成功!', url('AdminFileCategory/index'));
    }
...
tpl;
        ...
        $categoryTree = $portalCategoryModel->adminCategoryTableTree(6,$selectedIds, $tpl);
