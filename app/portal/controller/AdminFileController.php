...
class AdminFileController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $data        = $postService->adminArticleList($param,6);

        $data->appends($param);

        $portalCategoryModel = new PortalCategoryModel();
        $categoryTree        = $portalCategoryModel->adminCategoryTree(6, $categoryId);
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $portalPostModel->adminAddPage($data['post'], 6);
    ...
    public function editPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $portalPostModel->adminEditPage($data['post'], 6);
