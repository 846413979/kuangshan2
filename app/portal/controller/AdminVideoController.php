...
class AdminVideoController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $data        = $postService->adminArticleList($param,5);

        $data->appends($param);

        $portalCategoryModel = new PortalCategoryModel();
        $categoryTree        = $portalCategoryModel->adminCategoryTree(5, $categoryId);
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $portalPostModel->adminAddPage($data['post'], 5);
    ...
    public function editPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $portalPostModel->adminEditPage($data['post'], 5);
