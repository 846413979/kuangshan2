...
function getStaticHost() {
    var e = "static.", t = window.location.hostname;
...
function getImgRepositoryHost() {
    var e = window.globalObj.getProtocol(), t = "img01.", n = window.location.hostname;
...
function injectScript(e, t, n, i) {
    if (void 0 === i && (i = 0), i >= t.length) n(); else {
...
window.globalObj = window.globalObj || {}, function () {
    var e, t;
...
!function (global) {
    var req, s, head, baseElement, dataMain, src, interactiveScript, currentlyAddingScript, mainScript, subPath,
        version = "2.1.11", commentRegExp = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm,
    ...
    function newContext(l) {
        var n, e, p, u, c, y = {waitSeconds: 7, baseUrl: "./", paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {}},
        ...
        function w(e, t, n) {
            ...
            if (e && "." === e.charAt(0) && (t ? (h = p.slice(0, p.length - 1), l = (e = e.split("/")).length - 1, y.nodeIdCompat && jsSuffixRegExp.test(e[l]) && (e[l] = e[l].replace(jsSuffixRegExp, "")), function v(e) {
                var t, n, i = e.length;
                for (t = 0; t < i; t++) if ("." === (n = e[t])) e.splice(t, 1), t -= 1; else if (".." === n) {
                    if (1 === t && (".." === e[2] || ".." === e[0])) break;
                    0 < t && (e.splice(t - 1, 2), t -= 2)
                }
            }(e = h.concat(e)), e = e.join("/")) : 0 === e.indexOf("./") && (e = e.substring(2))), n && m && (p || g)) {
                e:for (o = (r = e.split("/")).length; 0 < o; o -= 1) {
                    if (s = r.slice(0, o).join("/"), p) for (a = p.length; 0 < a; a -= 1) if ((i = getOwn(m, p.slice(0, a).join("/"))) && (i = getOwn(i, s))) {
                        u = i, c = o;
                        break e
                    }
        ...
        function q() {
            var e, i, t = 1e3 * y.waitSeconds, r = t && p.startTime + t < (new Date).getTime(), o = [], a = [], s = !1,
                l = !0;
            if (!n) {
                if (n = !0, eachProp(f, function (e) {
                    var t = e.map, n = t.id;
                    if (e.enabled && (t.isDefine || a.push(e), !e.error)) if (!e.inited && r) C(n) ? s = i = !0 : (o.push(n), x(n)); else if (!e.inited && e.fetched && t.isDefine && (s = !0, !t.prefix)) return l = !1
        ...
        return u = {
            ...
            init: function (e, t, n, i) {
                ...
                this.depMaps.push(e), k(e, "defined", bind(this, function (e) {
                    var a, t, n, i = getOwn(g, this.map.id), r = this.map.name,
            ...
            configure: function (e) {
                ...
                var n = y.shim, i = {paths: !0, bundles: !0, config: !0, map: !0};
            ...
            makeRequire: function (o, a) {
                function s(e, t, n) {
                    ...
                    return a.enableBuildCallback && t && isFunction(t) && (t.__requireJsBuild = !0), "string" == typeof e ? isFunction(t) ? S(makeError("requireargs", "Invalid require call"), n) : o && hasProp(u, e) ? u[e](d[o.id]) : req.get ? req.get(p, e, o, s) : (i = E(e, o, !1, !0).id, hasProp(m, i) ? m[i] : S(makeError("notloaded", 'Module name "' + i + '" has not been loaded yet for context: ' + l + (o ? "" : ". Use require([])")))) : (A(), p.nextTick(function () {
                        A(), (r = _(E(null, o))).skipMap = a.skipMap, r.init(e, t, n, {enabled: !0}), q()
                    }), s)
                }
            ...
            nameToUrl: function (e, t, n) {
                ...
                if (req.jsExtRegExp.test(e)) a = e + (t || ""); else {
                    for (i = y.paths, o = (r = e.split("/")).length; 0 < o; o -= 1) if (s = getOwn(i, r.slice(0, o).join("/"))) {
...
var FOP = {}, wgtCommonPath = "wgt/frontPlugin/", wgtlib = "wgt/coreLibs/",
...
require.config({
    ...
    if (!window.isCWMP && isFrontEnv()) {
        ...
        if (1 <= $("div[id^='w_wbox'],div[id^='w_bbox']").length || 1 <= $("div[id^='w_fbox'],div[id^='w_sfbox']").length || 1 <= $("div[id^='w_cbox']").length) {
            var u = $("div[id^='w_wbox'],div[id^='w_bbox']").eq(0), c = $("div[id^='w_cbox']").eq(0),
                d = $("div[id^='w_fbox'],div[id^='w_sfbox']").eq(0), f = 1 <= u.length ? u : 1 <= c.length ? c : d,
                p = f[0].style.width;
...
var readyFun = function () {
    _isLoaded = !0, jQuery.fn.__ceverPC, $(".main").length, $(".main").length, $(".pagebox").length, $(".pagebox").length, require(["wgt_readyload"], function (n) {
        ...
        if (-1 != t.indexOf("$$1")) {
            ...
            $("html,body").animate({scrollTop: $(n).offset().top}), e.preventDefault()
        } else {
            n = t.substring(0, t.length - 3);
            $("html,body").animate({scrollTop: $(n).offset().top}, 0), e.preventDefault()
        }
    }), window.isStaticedDemo || require(["afterLoad"], function (e) {
        e.init()
    })
};
window.addEventListener ? window.addEventListener("load", readyFun) : window.attachEvent && window.attachEvent("onload", readyFun), function (e, t) {
    "object" == typeof module && "object" == typeof module.exports ? module.exports = e.document ? t(e, !0) : function (e) {
        if (!e.document) throw new Error("jQuery requires a window with a document");
        return t(e)
    } : t(e)
}("undefined" != typeof window ? window : this, function (m, e) {
    var d = [], c = d.slice, h = d.concat, s = d.push, r = d.indexOf, n = {}, t = n.toString, g = n.hasOwnProperty,
        v = {}, _ = function (e, t) {
            return new _.fn.init(e, t)
        }, i = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, o = /^-ms-/, a = /-([\da-z])/gi, l = function (e, t) {
            return t.toUpperCase()
        };

    function u(e) {
        var t = e.length, n = _.type(e);
    ...
    _.fn = _.prototype = {
        ...
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || _.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++) if (null != (r = arguments[s])) for (i in r) e = a[i], a !== (n = r[i]) && (u && n && (_.isPlainObject(n) || (t = _.isArray(n))) ? (o = t ? (t = !1, e && _.isArray(e) ? e : []) : e && _.isPlainObject(e) ? e : {}, a[i] = _.extend(u, o, n)) : n !== undefined && (a[i] = n));
        return a
    }, _.extend({
        expando: "jQuery" + ("8.8.8" + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            throw new Error(e)
        }, noop: function () {
            ...
            if (u(e)) for (; r < o; r++) null != (i = t(e[r], r, n)) && a.push(i); else for (r in e) null != (i = t(e[r], r, n)) && a.push(i);
            return h.apply([], a)
    ...
    var f = function (n) {
        var e, m, w, o, i, g, d, v, x, u, c, y, C, r, b, T, a, s, E, _ = "sizzle" + -new Date, k = n.document, S = 0,
            f = 0, l = re(), p = re(), h = re(), j = function (e, t) {
                return e === t && (c = !0), 0
            }, N = typeof undefined, q = {}.hasOwnProperty, t = [], A = t.pop, $ = t.push, P = t.push, D = t.slice,
            ...
            B = ":(" + H + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)",
            I = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$", "g"),
            W = new RegExp("^" + M + "*," + M + "*"), z = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"),
            X = new RegExp("=" + M + "*([^\\]'\"]*?)" + M + "*\\]", "g"), U = new RegExp(B),
            G = new RegExp("^" + F + "$"), J = {
                ID: new RegExp("^#(" + H + ")"),
                CLASS: new RegExp("^\\.(" + H + ")"),
            ...
            }, V = /^(?:input|select|textarea|button)$/i, Q = /^h\d$/i, Y = /^[^{]+\{\s*\[native \w/,
            K = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Z = /[+~]/, ee = /'|\\/g,
        ...
        for (e in m = ie.support = {}, i = ie.isXML = function (e) {
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === h && 0 === m ? function (e) {
                        ...
                        var i, r, o, a, s, l, u = g !== v ? "nextSibling" : "previousSibling", c = e.parentNode,
                        ...
                        if (c) {
                            ...
                            if (l = [v ? c.firstChild : c.lastChild], v && f) {
                                for (s = (i = (r = c[_] || (c[_] = {}))[p] || [])[0] === S && i[1], a = i[0] === S && i[2], o = s && c.childNodes[s]; o = ++s && o && o[u] || (a = s = 0) || l.pop();) if (1 === o.nodeType && ++a && o === e) {
                                    r[p] = [S, s, a];
                                    break
                                }
                            } else if (f && (i = (e[_] || (e[_] = {}))[p]) && i[0] === S) a = i[1]; else for (; (o = ++s && o && o[u] || (a = s = 0) || l.pop()) && ((y ? o.nodeName.toLowerCase() !== d : 1 !== o.nodeType) || !++a || (f && ((o[_] || (o[_] = {}))[p] = [S, a]), o !== e));) ;
            ...
            pseudos: {
                not: oe(function (e) {
                    ...
                    return G.test(n || "") || ie.error("unsupported lang: " + n), n = n.replace(te, ne).toLowerCase(), function (e) {
                        var t;
                        do {
        ...
        function ye(h, m, g, v, y, e) {
            return v && !v[_] && (v = ye(v)), y && !y[_] && (y = ye(y, e)), oe(function (e, t, n, i) {
                var r, o, a, s = [], l = [], u = t.length, c = e || function p(e, t, n) {
                        ...
                        return n
                    }(m || "*", n.nodeType ? [n] : n, []), d = !h || !e && m ? c : ve(c, s, h, n, i),
                    f = g ? y || (e ? h : u || v) ? [] : t : d;
                if (g && g(d, f, n, i), v) for (r = ve(f, l), v(r, [], n, i), o = r.length; o--;) (a = r[o]) && (f[l[o]] = !(d[l[o]] = a));
                if (e) {
                    if (y || h) {
                        if (y) {
        ...
        function be(e) {
            ...
            }]; s < r; s++) if (t = w.relative[e[s].type]) c = [me(ge(c), t)]; else {
                if ((t = w.filter[e[s].type].apply(null, e[s].matches))[_]) {
                    for (n = ++s; n < r && !w.relative[e[n].type]; n++) ;
                    return ye(1 < s && ge(c), 1 < s && he(e.slice(0, s - 1).concat({value: " " === e[s - 2].type ? "*" : ""})).replace(I, "$1"), t, s < n && be(e.slice(s, n)), n < r && be(e = e.slice(n)), n < r && he(e))
                }
                c.push(t)
            }
            return ge(c)
        ...
        return pe.prototype = w.filters = w.pseudos, w.setFilters = new pe, g = ie.tokenize = function (e, t) {
            ...
            if (!o) {
                ...
                (o = h(e, function a(g, v) {
                    var y = 0 < v.length, b = 0 < g.length, e = function (e, t, n, i, r) {
                        var o, a, s, l = 0, u = "0", c = e && [], d = [], f = x, p = e || b && w.find.TAG("*", r),
                            h = S += null == f ? 1 : Math.random() || .1, m = p.length;
                        ...
                        if (l += u, y && u !== l) {
                            ...
                            if (e) {
                                if (0 < l) for (; u--;) c[u] || d[u] || (d[u] = A.call(i));
                                d = ve(d)
                            }
            ...
            if (n = n || [], 1 === c.length) {
                ...
                for (r = J.needsContext.test(e) ? 0 : o.length; r-- && (a = o[r], !w.relative[s = a.type]);) if ((l = w.find[s]) && (i = l(a.matches[0].replace(te, ne), Z.test(o[0].type) && fe(t.parentNode) || t))) {
    ...
    var p = _.expr.match.needsContext, y = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, b = /^.[^:#\[\.,]*$/;
    ...
    (_.fn.init = function (e, t) {
        ...
        if (n[1]) {
            if (t = t instanceof _ ? t[0] : t, _.merge(this, _.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : C, !0)), y.test(n[1]) && _.isPlainObject(t)) for (n in t) _.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
            return this
        }
    ...
    var E = /^(?:parents|prev(?:Until|All))/, k = {children: !0, contents: !0, next: !0, prev: !0};
    ...
    _.extend({
        ...
        has: function (e) {
            ...
            for (var n, i = 0, r = this.length, o = [], a = p.test(e) || "string" != typeof e ? _(e, t || this.context) : 0; i < r; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? -1 < a.index(n) : 1 === n.nodeType && _.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
    ...
    _.Callbacks = function (r) {
        ...
        var o, t, n, a, i, s, l = [], u = !r.once && [], c = function (e) {
            for (t = r.memory && e, n = !0, i = s || 0, s = 0, a = l.length, o = !0; l && i < a; i++) if (!1 === l[i].apply(e[0], e[1]) && r.stopOnFalse) {
                t = !1;
                break
            }
        ...
        Deferred: function (e) {
            ...
            var r, t, n, i = 0, o = c.call(arguments), a = o.length,
                s = 1 !== a || e && _.isFunction(e.promise) ? a : 0, l = 1 === s ? e : _.Deferred(),
                u = function (t, n, i) {
                    return function (e) {
                        n[t] = this, i[t] = 1 < arguments.length ? c.call(arguments) : e, i === r ? l.notifyWith(n, i) : --s || l.resolveWith(n, i)
                    }
                };
            if (1 < a) for (r = new Array(a), t = new Array(a), n = new Array(a); i < a; i++) o[i] && _.isFunction(o[i].promise) ? o[i].promise().done(u(i, n, o)).fail(l.reject).progress(u(i, t, r)) : --s;
        ...
        if (!j) if (j = _.Deferred(), "complete" === C.readyState) setTimeout(_.ready); else if (C.addEventListener) C.addEventListener("DOMContentLoaded", $, !1), m.addEventListener("load", $, !1); else {
    ...
    v.ownLast = "0" !== P, v.inlineBlockNeedsLayout = !1, _(function () {
        ...
        var t = _.noData[(e.nodeName + " ").toLowerCase()], n = +e.nodeType || 1;
        return (1 === n || 9 === n) && (!t || !0 !== t && e.getAttribute("classid") === t)
    };
    var O = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, L = /([A-Z])/g;
    ...
    function H(e) {
        var t;
        for (t in e) if (("data" !== t || !_.isEmptyObject(e[t])) && "toJSON" !== t) return !1;
        return !0
    }
    ...
    function F(e, t, n, i) {
        if (_.acceptData(e)) {
            ...
            if (u && l[u] && (i || l[u].data) || n !== undefined || "string" != typeof t) return u || (u = s ? e[a] = d.pop() || _.guid++ : a), l[u] || (l[u] = s ? {} : {toJSON: _.noop}), "object" != typeof t && "function" != typeof t || (i ? l[u] = _.extend(l[u], t) : l[u].data = _.extend(l[u].data, t)), o = l[u], i || (o.data || (o.data = {}), o = o.data), n !== undefined && (o[_.camelCase(t)] = n), "string" == typeof t ? null == (r = o[t]) && (r = o[_.camelCase(t)]) : r = o, r
        }
    }
    ...
    var B = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, I = ["Top", "Right", "Bottom", "Left"], W = function (e, t) {
        return e = t || e, "none" === _.css(e, "display") || !_.contains(e.ownerDocument, e)
    }, z = _.access = function (e, t, n, i, r, o, a) {
        var s = 0, l = e.length, u = null == n;
        if ("object" === _.type(n)) for (s in r = !0, n) _.access(e, t, s, n[s], !0, o, a); else if (i !== undefined && (r = !0, _.isFunction(i) || (a = !0), u && (t = a ? (t.call(e, i), null) : (u = t, function (e, t, n) {
            return u.call(_(e), n)
    ...
    var U = /^(?:input|select|textarea)$/i, G = /^key/, J = /^(?:mouse|pointer|contextmenu)|click/,
        V = /^(?:focusinfocus|focusoutblur)$/, Q = /^([^.]*)(?:\.(.+)|)$/;
    ...
    _.event = {
        ...
        remove: function (e, t, n, i, r) {
            ...
            if (g && (c = g.events)) {
                for (u = (t = (t || "").match(N) || [""]).length; u--;) if (p = m = (s = Q.exec(t[u]) || [])[1], h = (s[2] || "").split(".").sort(), p) {
        ...
        trigger: function (e, t, n, i) {
            var r, o, a, s, l, u, c, d = [n || C], f = g.call(e, "type") ? e.type : e,
            ...
            if (a = u = n = n || C, 3 !== n.nodeType && 8 !== n.nodeType && !V.test(f + _.event.triggered) && (0 <= f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), o = f.indexOf(":") < 0 && "on" + f, (e = e[_.expando] ? e : new _.Event(f, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = undefined, e.target || (e.target = n), t = null == t ? [e] : _.makeArray(t, [e]), l = _.event.special[f] || {}, i || !l.trigger || !1 !== l.trigger.apply(n, t))) {
                ...
                for (c = 0; (a = d[c++]) && !e.isPropagationStopped();) e.type = 1 < c ? s : l.bindType || f, (r = (_._data(a, "events") || {})[e.type] && _._data(a, "handle")) && r.apply(a, t), (r = o && a[o]) && r.apply && _.acceptData(a) && (e.result = r.apply(a, t), !1 === e.result && e.preventDefault());
        ...
        dispatch: function (e) {
            e = _.event.fix(e);
            var t, n, i, r, o, a, s = c.call(arguments), l = (_._data(this, "events") || {})[e.type] || [],
                u = _.event.special[e.type] || {};
            if ((s[0] = e).delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, e)) {
                for (a = _.event.handlers.call(this, e, l), t = 0; (r = a[t++]) && !e.isPropagationStopped();) for (e.currentTarget = r.elem, o = 0; (i = r.handlers[o++]) && !e.isImmediatePropagationStopped();) e.namespace_re && !e.namespace_re.test(i.namespace) || (e.handleObj = i, e.data = i.data, (n = ((_.event.special[i.origType] || {}).handle || i.handler).apply(r.elem, s)) !== undefined && !1 === (e.result = n) && (e.preventDefault(), e.stopPropagation()));
        ...
        simulate: function (e, t, n, i) {
            var r = _.extend(new _.Event, n, {type: e, isSimulated: !0, originalEvent: {}});
        ...
        setup: function () {
            ...
            _.event.add(this, "click._submit keypress._submit", function (e) {
                var t = e.target, n = _.nodeName(t, "input") || _.nodeName(t, "button") ? t.form : undefined;
    ...
    }), v.focusinBubbles || _.each({focus: "focusin", blur: "focusout"}, function (n, i) {
        var r = function (e) {
            _.event.simulate(i, e.target, _.event.fix(e), !0)
        };
        _.event.special[i] = {
            setup: function () {
                var e = this.ownerDocument || this, t = _._data(e, i);
                t || e.addEventListener(n, r, !0), _._data(e, i, (t || 0) + 1)
            }, teardown: function () {
                var e = this.ownerDocument || this, t = _._data(e, i) - 1;
        ...
        on: function (e, t, n, i, r) {
            ...
            if (null == n && null == i ? (i = t, n = t = undefined) : null == i && ("string" == typeof t ? (i = n, n = undefined) : (i = n, n = t, t = undefined)), !1 === i) i = K; else if (!i) return this;
    ...
    var te = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ne = / jQuery\d+="(?:null|\d+)"/g, ie = new RegExp("<(?:" + te + ")[\\s/>]", "i"), re = /^\s+/,
        oe = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, ae = /<([\w:]+)/,
        se = /<tbody/i, le = /<|&#?\w+;/, ue = /<(?:script|style|link)/i, ce = /checked\s*(?:[^=]|=\s*.checked.)/i,
        de = /^$|\/(?:java|ecma)script/i, fe = /^true\/(.*)/, pe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, he = {
    ...
    function ge(e, t) {
        ...
        if (!o) for (o = [], n = e.childNodes || e; null != (i = n[r]); r++) !t || _.nodeName(i, t) ? o.push(i) : _.merge(o, ge(i, t));
    ...
    function Ce(e, t) {
        if (1 === t.nodeType && _.hasData(e)) {
            ...
            if (s) for (n in delete a.handle, a.events = {}, s) for (i = 0, r = s[n].length; i < r; i++) _.event.add(t, n, s[n][i]);
    ...
    he.optgroup = he.option, he.tbody = he.tfoot = he.colgroup = he.caption = he.thead, he.th = he.td, _.extend({
        clone: function (e, t, n) {
            ...
            if (v.html5Clone || _.isXMLDoc(e) || !ie.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (me.innerHTML = e.outerHTML, me.removeChild(o = me.firstChild)), !(v.noCloneEvent && v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || _.isXMLDoc(e))) for (i = ge(o), s = ge(e), a = 0; null != (r = s[a]); ++a) i[a] && Te(r, i[a]);
            if (t) if (n) for (s = s || ge(e), i = i || ge(o), a = 0; null != (r = s[a]); a++) Ce(r, i[a]); else Ce(e, o);
            return 0 < (i = ge(o, "script")).length && xe(i, !l && ge(e, "script")), i = s = r = null, o
        }, buildFragment: function (e, t, n, i) {
            for (var r, o, a, s, l, u, c, d = e.length, f = ee(t), p = [], h = 0; h < d; h++) if ((o = e[h]) || 0 === o) if ("object" === _.type(o)) _.merge(p, o.nodeType ? [o] : o); else if (le.test(o)) {
                ...
                if (!v.leadingWhitespace && re.test(o) && p.push(t.createTextNode(re.exec(o)[0])), !v.tbody) for (r = (o = "table" !== l || se.test(o) ? "<table>" !== c[1] || se.test(o) ? 0 : s : s.firstChild) && o.childNodes.length; r--;) _.nodeName(u = o.childNodes[r], "tbody") && !u.childNodes.length && o.removeChild(u);
                for (_.merge(p, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                s = f.lastChild
            } else p.push(t.createTextNode(o));
            for (s && f.removeChild(s), v.appendChecked || _.grep(ge(p, "input"), ve), h = 0; o = p[h++];) if ((!i || -1 === _.inArray(o, i)) && (a = _.contains(o.ownerDocument, o), s = ge(f.appendChild(o), "script"), a && xe(s), n)) for (r = 0; o = s[r++];) de.test(o.type || "") && n.push(o);
            return s = null, f
        }, cleanData: function (e, t) {
            for (var n, i, r, o, a = 0, s = _.expando, l = _.cache, u = v.deleteExpando, c = _.event.special; null != (n = e[a]); a++) if ((t || _.acceptData(n)) && (o = (r = n[s]) && l[r])) {
                if (o.events) for (i in o.events) c[i] ? _.event.remove(n, i) : _.removeEvent(n, i, o.handle);
        ...
        text: function (e) {
            ...
            if (u && (e = (s = _.buildFragment(n, this[0].ownerDocument, !1, this)).firstChild, 1 === s.childNodes.length && (s = e), e)) {
                ...
                if (r) for (a = o[o.length - 1].ownerDocument, _.map(o, we), l = 0; l < r; l++) t = o[l], de.test(t.type || "") && !_._data(t, "globalEval") && _.contains(a, t) && (t.src ? _._evalUrl && _._evalUrl(t.src) : _.globalEval((t.text || t.textContent || t.innerHTML || "").replace(pe, "")));
                s = e = null
            }
            return this
        }
    ...
    var Oe = /alpha\([^)]*\)/i, Le = /opacity\s*=\s*([^)]*)/, Me = /^(none|table(?!-c[ea]).+)/,
        He = new RegExp("^(" + B + ")(.*)$", "i"), Fe = new RegExp("^([+-])=(" + B + ")", "i"),
        Re = {position: "absolute", visibility: "hidden", display: "block"},
        Be = {letterSpacing: "0", fontWeight: "400"}, Ie = ["Webkit", "O", "Moz", "ms"];

    function We(e, t) {
        if (t in e) return t;
        for (var n = t.charAt(0).toUpperCase() + t.slice(1), i = t, r = Ie.length; r--;) if ((t = Ie[r] + n) in e) return t;
        return i
    }
    ...
    function Ge(e, t, n) {
        var i = !0, r = "width" === t ? e.offsetWidth : e.offsetHeight, o = Ne(e),
    ...
    _.extend({
        ...
        get: function (e, t) {
            ...
            var n = e.style, i = e.currentStyle, r = _.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
        ...
        if (t) return _.swap(e, {display: "inline-block"}, qe, [e, "marginRight"])
    ...
    var Ve, Qe, Ye, Ke, Ze, et, tt, nt = /^(?:toggle|show|hide)$/,
        it = new RegExp("^(?:([+-])=|)(" + B + ")([a-z%]*)$", "i"), rt = /queueHooks$/, ot = [function tn(t, e, n) {
            ...
            if (_.isEmptyObject(d)) "inline" === ("none" === u ? je(t.nodeName) : u) && (f.display = u); else for (i in h ? "hidden" in h && (p = h.hidden) : h = _._data(t, "fxshow", {}), o && (h.hidden = !p), p ? _(t).show() : c.done(function () {
                _(t).hide()
            }), c.done(function () {
                var e;
            ...
            "*": [function (e, t) {
                var n = this.createTween(e, t), i = n.cur(), r = it.exec(t), o = r && r[3] || (_.cssNumber[e] ? "" : "px"),
                    a = (_.cssNumber[e] || "px" !== o && +i) && it.exec(_.css(n.elem, e)), s = 1, l = 20;
                if (a && a[3] !== o) for (o = o || a[3], r = r || [], a = +i || 1; a /= s = s || ".5", _.style(n.elem, e, a + o), s !== (s = n.cur() / i) && 1 !== s && --l;) ;
    ...
    function ut(e, t, n) {
        for (var i, r = (at[t] || []).concat(at["*"]), o = 0, a = r.length; o < a; o++) if (i = r[o].call(n, t, e)) return i
    }
    ...
    function ct(o, e, t) {
        ...
        for (!function d(e, t) {
            var n, i, r, o, a;
            for (n in e) if (r = t[i = _.camelCase(n)], o = e[n], _.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (a = _.cssHooks[i]) && "expand" in a) for (n in o = a.expand(o), delete e[i], o) n in e || (e[n] = o[n], t[n] = r); else t[i] = r
        }(c, u.opts.specialEasing); i < r; i++) if (n = ot[i].call(u, o, c, u.opts)) return n;
    ...
    _.Animation = _.extend(ct, {
        ...
        fadeTo: function (e, t, n, i) {
            ...
            var r = _.isEmptyObject(t), o = _.speed(e, n, i), a = function () {
            ...
            return "string" != typeof r && (o = e, e = r, r = undefined), e && !1 !== r && this.queue(r || "fx", []), this.each(function () {
                var e = !0, t = null != r && r + "queueHooks", n = _.timers, i = _._data(this);
            ...
            return !1 !== a && (a = a || "fx"), this.each(function () {
                var e, t = _._data(this), n = t[a + "queue"], i = t[a + "queueHooks"], r = _.timers,
                    o = n ? n.length : 0;
    ...
    }, _.fx.speeds = {slow: 600, fast: 200, _default: 400}, _.fn.delay = function (i, e) {
    ...
    _.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, i = e.options, r = e.selectedIndex, o = "select-one" === e.type || r < 0, a = o ? null : [], s = o ? r + 1 : i.length, l = r < 0 ? s : o ? r : 0; l < s; l++) if (((n = i[l]).selected || l === r) && (v.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !_.nodeName(n.parentNode, "optgroup"))) {
                        if (t = _(n).val(), o) return t;
                        a.push(t)
                    }
                    return a
                }, set: function (e, t) {
                    for (var n, i, r = e.options, o = _.makeArray(t), a = r.length; a--;) if (i = r[a], 0 <= _.inArray(_.valHooks.option.get(i), o)) try {
                        i.selected = n = !0
                    } catch (s) {
                        i.scrollHeight
                    } else i.selected = !1;
    ...
    _.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (o && 1 === e.nodeType) for (; n = o[r++];) i = _.propFix[n] || n, _.expr.match.bool.test(n) ? vt && gt || !mt.test(n) ? e[i] = !1 : e[_.camelCase("default-" + n)] = e[i] = !1 : _.attr(e, n, ""), e.removeAttribute(gt ? n : i)
        }, attrHooks: {
            type: {
                set: function (e, t) {
    ...
    _.fn.extend({
        addClass: function (t) {
            ...
            if (u) for (e = (t || "").match(N) || []; s < l; s++) if (i = 1 === (n = this[s]).nodeType && (n.className ? (" " + n.className + " ").replace(wt, " ") : " ")) {
            ...
            return "boolean" == typeof t && "string" === o ? t ? this.addClass(r) : this.removeClass(r) : _.isFunction(r) ? this.each(function (e) {
                ...
                if ("string" === o) for (var e, t = 0, n = _(this), i = r.match(N) || []; e = i[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e); else o !== D && "boolean" !== o || (this.className && _._data(this, "__className__", this.className), this.className = this.className || !1 === r ? "" : _._data(this, "__className__") || "")
            })
        }, hasClass: function (e) {
    ...
    function Ot(o) {
        return function (e, t) {
            ...
            if (_.isFunction(t)) for (; n = r[i++];) "+" === n.charAt(0) ? (n = n.slice(1) || "*", (o[n] = o[n] || []).unshift(t)) : (o[n] = o[n] || []).push(t)
        }
    }
    ...
    Et = At.exec(_t.toLowerCase()) || [], _.extend({
        ...
        ajax: function (e, t) {
            ...
            var n, i, f, p, h, m, g, r, v = _.ajaxSetup({}, t), y = v.context || v,
                b = v.context && (y.nodeType || y.jquery) ? _(y) : _.event, w = _.Deferred(),
                x = _.Callbacks("once memory"), C = v.statusCode || {}, o = {}, a = {}, T = 0, s = "canceled", E = {
                    readyState: 0, getResponseHeader: function (e) {
                        var t;
                        if (2 === T) {
                            if (!r) for (r = {}; t = jt.exec(p);) r[t[1].toLowerCase()] = t[2];
                            t = r[e.toLowerCase()]
                        }
                        ...
                        var t;
                        if (e) if (T < 2) for (t in e) C[t] = [C[t], e[t]]; else E.always(e[E.status]);
                        return this
                    }, abort: function (e) {
                        var t = e || s;
            ...
            for (i in s = "abort", {success: 1, error: 1, complete: 1}) E[i](v[i]);
            if (g = Lt(Pt, v, t, E)) {
                ...
                2 !== T && (T = 2, h && clearTimeout(h), g = undefined, p = i || "", E.readyState = 0 < e ? 4 : 0, r = 200 <= e && e < 300 || 304 === e, n && (s = function c(e, t, n) {
                    ...
                    for (o = c.shift(); o;) if (e.responseFields[o] && (n[e.responseFields[o]] = t), !l && i && e.dataFilter && (t = e.dataFilter(t, e.dataType)), l = o, o = c.shift()) if ("*" === o) o = l; else if ("*" !== l && l !== o) {
                        ...
                        if (!0 !== a) if (a && e["throws"]) t = a(t); else try {
                            ...
                            return {state: "parsererror", error: a ? nn : "No conversion from " + l + " to " + o}
                        }
                    }
        ...
        return _.ajax({url: e, type: "GET", dataType: "script", async: !1, global: !1, "throws": !0})
    }, _.fn.extend({
        wrapAll: function (t) {
            if (_.isFunction(t)) return this.each(function (e) {
    ...
    function Wt(n, e, i, r) {
        ...
        }); else if (i || "object" !== _.type(e)) r(n, e); else for (t in e) Wt(n + "[" + t + "]", e[t], i, r)
    }
    ...
    var zt = 0, Xt = {}, Ut = _.ajaxSettings.xhr();
        ...
        if (!l.crossDomain || v.cors) return {
            send: function (e, o) {
                ...
                a.send(l.hasContent && l.data || null), u = function (e, t) {
                    var n, i, r;
                    if (u && (t || 4 === a.readyState)) if (delete Xt[s], u = undefined, a.onreadystatechange = _.noop, t) 4 !== a.readyState && a.abort(); else {
    ...
    _.ajaxSetup({
        ...
        var i, r, o,
            a = !1 !== e.jsonp && (Vt.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && Vt.test(e.data) && "data");
    ...
    _.offset = {
        ...
        _.each({padding: "inner" + o, content: a, "": "outer" + o}, function (i, e) {
            _.fn[e] = function (e, t) {
    ...
    var Zt = m.jQuery, en = m.$;
    return _.noConflict = function (e) {
        return m.$ === _ && (m.$ = en), e && m.jQuery === _ && (m.jQuery = Zt), _
    }, typeof e === D && (m.jQuery = m.$ = _), _
});
var noMdArr = [115329, 40059, 35109, 35108], noPushArr = [115329, 40059, 144128, 35109, 35108];

function myBrowser() {
    var e = navigator.userAgent, t = !1;
    (-1 < e.indexOf("Firefox") && (t = !0), -1 < e.indexOf("Chrome") && (t = !0), -1 < e.indexOf("Safari") && (t = !0), -1 < e.indexOf("compatible") && -1 < e.indexOf("MSIE")) && (new RegExp("MSIE (\\d+\\.\\d+);").test(e), 10 === parseFloat(RegExp.$1) && (t = !0));
    -1 < e.indexOf("Trident") && -1 < e.indexOf("rv:11.0") && (t = !0), -1 < e.indexOf("Edge") && (t = !0), -1 < e.indexOf("AppleWebKit") && (t = !0), -1 < e.indexOf("se 2.x") && (t = !0);
    try {
...
function checkBrowser() {
    var e = new Date((new Date).toLocaleDateString()).getTime(), t = Number(getCookie("checkBrowser"));
...
function IsPC() {
    for (var e = navigator.userAgent, t = ["Android", "iPhone", "SymbianOS", "Windows Phone", "iPad", "iPod"], n = !0, i = 0; i < t.length; i++) if (0 < e.indexOf(t[i])) {
        n = !1;
        break
    }
    return n
...
if ("100009" != unittype && "100084" != unittype && "100007" != unittype && null != tenant.mobileDomain && "" != tenant.mobileDomain && 6 == tenant.mobileStatus && null == getCookie(noredirectCookieName) && !getParentWindow().VisualManager) {
    ...
    if ("string" == typeof window.intelligetJump && /^{/.test(window.intelligetJump) ? intelligetJumpObj = JSON.parse(window.intelligetJump) : "object" == typeof window.intelligetJump && (intelligetJumpObj = window.intelligetJump), intelligetJumpObj && "true" == intelligetJumpObj.identification && mobileAgentReg.test(userAgent) && 6 == tenant.mobileStatus) {
        var path = window.location.pathname, mobileTarget = getSettingMobileUrl();
        try {
...
for (var website = [100085, 110001, 120001, 130001, 111001, 121001, 150001, 140001, 141001, 130011, 160001, 161001, 170001, 100019, 181001, 100001, 100081], b = 0; b < website.length; b++) if (window.tenant.unittype == website[b]) {
    if (11 == tenant.status && !getCookie("_nofirst")) try {
        $.ajax({
            url: "/toupgrade/online", method: "get", timeout: 200, success: function (e) {
...
try {
    ...
    function setHeight() {
        ...
        var t = maxComp($("body").find(".pagebox").children("div[id^='c_']")),
            n = maxW($("body").find(".pagebox").children("div[id^='w_']")), i = n < t ? t : n,
    ...
    $(function () {
        $.isAbsStyle() && setInterval(setHeight, 300), $("div").on("FR_CHANGECOMPHEIGHT", function () {
            var e = $(this);
            if ("absolute" == e.css("position")) if (null != e.attr("id")) if (0 != !e.attr("id").indexOf("c_") || 0 != !e.attr("id").indexOf("w_")) {
            ...
            } else e.parent().trigger("FR_CHANGECOMPHEIGHT"); else e.parent().trigger("FR_CHANGECOMPHEIGHT"); else e.parent().trigger("FR_CHANGECOMPHEIGHT")
        })
    })
} catch (e) {
}
...
!function () {
    ...
    if (t.setAttribute("type", "text/javascript"), t.setAttribute("src", "/themes/simpleboot3/public/assets/js/response.js"), document.body.appendChild(t), t.onload = function () {
        !0 !== window.isResponse && "true" !== window.isResponse || (window.siteIsPc ? n("mo") : n("pc"))
    }, "100001" == window.tenant.unittype) {
        var i = $("body").attr("data-pageid"), r = (navigator.browserLanguage || navigator.language).toLowerCase(),
            o = r.substring(0, 2);
    ...
    $("div[id^=w_fbox-]").length && (s = !0), $("div[id^=w_sfbox-]").length && (s = !0), function () {
        if (s) {
        ...
        var n = $(this).find(".p_relationbtntab.active").parent().index(".e_link"),
            i = $(this).find(".p_box002>div").eq(n).css("overflow"), r = $(this).attr("id");
        "hidden" == i && addResetCompListener(r)
    }), $("body").on("click touchstart", ".w_relationbtntab>.p_box001>.e_link", function (e) {
        var t = $t = $(this), n = $(this).closest(".w_relationbtntab"), i = n.find(">.p_box001>.e_link"),
        ...
        var o = $(this).index(".e_link"), a = $(this).closest(".w_relationbtntab").find(".p_box002>div").eq(o),
